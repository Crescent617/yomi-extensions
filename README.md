...
| 类型 | 资产 | 说明 |
|---|---|---|
| skill | [`skills/task-board/`](skills/task-board/SKILL.md) | 共享任务板约定：`.yomi/board/` 目录、claim 协议、状态机、协调者聚合姿势 |
...
ln -s ~/repos/yomi-extensions/skills/task-board ~/.agents/skills/task-board
```
